...
| Release packaging | Partial (strengthened) | The 0.35 development package is self-contained Windows x64, contains the engine/runtime/manifest and zero Python files. Packaging canonicalizes copied JSON/Markdown and the embedded schema to BOM-less UTF-8/LF and normalizes Windows packaging onto Windows PowerShell 5.1. The current transform checkpoint produced the same 195-file, 85,150,302-byte tree and 36,200,235-byte ZIP in two local builds and mandatory CI run `29970012359` at SHA-256 `e1ef21c763cae801f48bcfa43d1513ff279936a8fd026e00b28a04133755afe8`; the downloaded hosted Windows ZIP matched both local archives byte for byte. Packaged discovery reported 85 actions/15 exposed tools and opened no Word process. The preceding inspection-operation checkpoint matched mandatory CI run `29967113037` with identical local/hosted 195-file, 85,107,806-byte trees and 36,189,483-byte ZIPs at SHA-256 `ff910c0c314ccb98b7f716f40cfa6e4580659b763ee3d657e138c1d6732b4632`. The earlier exact 0.35 live package, SHA-256 `e8f2e4b74fe65213197126c7aafb445452bd0e80bc05f7206d82672e4b09e59b`, passed the complete 48-action real-Word gate; later saved-package slices do not change live COM code | Optional signing/provenance policy, published artifact and refreshed licensed Word gate before release |
