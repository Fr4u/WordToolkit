...
| Release packaging | Partial (strengthened) | The 0.36 development package is self-contained Windows x64, contains the engine/runtime/manifest and zero Python files. Packaging canonicalizes copied JSON/Markdown and the embedded schema to BOM-less UTF-8/LF and normalizes Windows packaging onto Windows PowerShell 5.1. The exact-target SVG checkpoint produced identical 196-file, 85,501,261-byte trees and 36,302,166-byte ZIPs in two local builds at SHA-256 `608fa76a93d737d9434ea0573316ee8dbb4e8baba7300e49a727e4687589ce7a`; explicitly defined UTF-8/LF manifests of sorted relative path, byte length and file SHA-256 fields matched the enabled personal-plugin cache at SHA-256 `18e02ad4487212d8d7429d2dc99360c742d183650737eea237d78015f5c7cfe9` with zero file differences. Hosted CI for this 0.36 checkpoint is pending. The preceding 0.35 HTML checkpoint passed all five jobs in run `29988472344`, and its downloaded Windows artifact matched its two local builds byte for byte. The earlier exact 0.35 live package, SHA-256 `e8f2e4b74fe65213197126c7aafb445452bd0e80bc05f7206d82672e4b09e59b`, passed the complete 48-action real-Word gate; later saved-package slices do not change live COM code | Optional signing/provenance policy and refreshed licensed Word gate before release |
...
- The current semantic-SVG checkpoint exposes
  ...
  exactly at 196 files, 85,501,261 expanded bytes and ZIP SHA-256
  `608fa76a93d737d9434ea0573316ee8dbb4e8baba7300e49a727e4687589ce7a`;
