...
| Requirement | State | Current evidence | Exit condition |
|---|---|---|---|
| Unit/regression tests | Partial | 316 engine, 218 native and 1273 Python tests pass at the current checkpoint, with 16 intentional Python skips | Coverage for every required feature and published failure corpus |
...
| Release packaging | Partial (strengthened) | The 0.35 development package is self-contained Windows x64, contains the engine/runtime/manifest and zero Python files. Packaging canonicalizes copied JSON/Markdown and the embedded schema to BOM-less UTF-8/LF and normalizes Windows packaging onto Windows PowerShell 5.1. The current MCE checkpoint produced the same 195-file, 84,713,190-byte tree and 36,077,499-byte ZIP in two local builds and mandatory CI run `29951495361`; the hosted artifact matched both local archives and expanded trees byte for byte at SHA-256 `5312432d0ff5e8ea2c0c4ca664011225be7ea7ad49a0b7b091aa9db4efba2ea3`, and all five jobs passed with zero annotations. The preceding chart checkpoint matched mandatory CI run `29947553481` at SHA-256 `26b7c1ff41933a26a2cd812aec70abe2f74408005eba8a76d48918409f2f0f88`. The semantic-golden checkpoint matched mandatory CI run `29944487747` at SHA-256 `bdbeaf9414e1b56311c6518c49787a76dc700da0fff184cbf62f8bb2c0079ed5`. The earlier exact 0.35 live package, SHA-256 `e8f2e4b74fe65213197126c7aafb445452bd0e80bc05f7206d82672e4b09e59b`, passed the complete 48-action real-Word gate; later saved-package slices do not change live COM code | Optional signing/provenance policy, published artifact and refreshed licensed Word gate before release |

## Current checkpoint evidence

- `dotnet test native/WordToolkit.Engine.Tests` — 316 passed.
- `dotnet test native/WordToolkit.Native.Tests` — 218 passed.
...
- `scripts/build_native_plugin.ps1` — self-contained native package built with no
  Python runtime.
- The current development head exposes 14 public tools and 82 lazy actions. Two local
  builds produced the same 195-file, 84,713,190-byte tree and 36,077,499-byte ZIP with
  SHA-256
  `5312432d0ff5e8ea2c0c4ca664011225be7ea7ad49a0b7b091aa9db4efba2ea3`.
  Through the packaged executable, the real LibreOffice chart fixture produced an MCE
  summary for 11 XML parts, five rules and one alternate-content block in a
  1,218-character data object and 3,054-character complete response. It opened neither
  Word nor an embedded workbook, followed no external target, mutated nothing, returned
  no namespace URI, source-part name, chart formula or raw XML and used no Python.
