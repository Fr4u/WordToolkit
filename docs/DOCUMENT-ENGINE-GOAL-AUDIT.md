...
| Requirement | State | Current evidence | Exit condition |
|---|---|---|---|
| Unit/regression tests | Partial | 392 engine, 266 native and 1273 Python tests pass at the current checkpoint, with 16 intentional Python skips | Coverage for every required feature and published failure corpus |
...
- The current semantic-HTML checkpoint exposes
  ...
  supported package builds matched exactly at 196 files, 85,424,800 expanded bytes and
  ZIP SHA-256 `dbeef0225f8c8d6afdda0d15c68ebf3e942cbdf3dee81268add8a7516993f1ea`;
  expanded manifests matched at SHA-256
  `c6ce1a67376717e4d4a4c440d9ace0dbc50d24e058f2b2c737dba2ea1e05cddc`.
  Packaged rendering of the real Mammoth fixture produced the same 3,628-byte artifact
  across 15 cold processes at 252.18 ms median and 302.14 ms p95/max, left the fixture
  ...
  because the in-app browser blocked the local URL and no bypass was attempted.
