...
- `source.native_action_contract_sha256`: canonical native 120-action subset, core
...
This keeps discovery bounded instead of paying for all 120 schemas.
...
All 120 operations have input schemas and MCP effect annotations. Extension catalog,
