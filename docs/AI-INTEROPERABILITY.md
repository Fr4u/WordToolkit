...
- `source.native_action_contract_sha256`: canonical native 145-action subset, core
...
This keeps discovery bounded instead of paying for all 145 schemas.
...
All 145 operations have input schemas and MCP effect annotations. Extension catalog,
