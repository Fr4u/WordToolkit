...
- `source.native_action_contract_sha256`: canonical native 90-action subset, core
...
This keeps discovery bounded instead of paying for all 90 schemas.
...
the remaining 83 are still uncovered. Missing metadata
