...
- `source.native_action_contract_sha256`: canonical native 148-action subset, core
...
This keeps discovery bounded instead of paying for all 148 schemas.
...
All 148 operations have input schemas and MCP effect annotations. Extension catalog,
