...
- `source.native_action_contract_sha256`: canonical native 105-action subset, core
...
This keeps discovery bounded instead of paying for all 105 schemas.
...
All 105 operations have input schemas and MCP effect annotations. Semantic query,
...
insertion, native authority-citation marking/table-of-authorities insertion and guarded
reference-table update have explicit output-schema, permission, reversibility and
