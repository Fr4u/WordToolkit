...
- `source.native_action_contract_sha256`: canonical native 101-action subset, core
...
This keeps discovery bounded instead of paying for all 101 schemas.
...
All 101 operations have input schemas and MCP effect annotations. Semantic query,
...
SmartArt text prepare/apply pair have explicit output-schema, permission,
