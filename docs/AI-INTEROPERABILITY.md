...
- `source.native_action_contract_sha256`: canonical native 147-action subset, core
...
This keeps discovery bounded instead of paying for all 147 schemas.
...
All 147 operations have input schemas and MCP effect annotations. Extension catalog,
