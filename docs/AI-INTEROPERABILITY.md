...
- `source.native_action_contract_sha256`: canonical native 146-action subset, core
...
This keeps discovery bounded instead of paying for all 146 schemas.
...
All 146 operations have input schemas and MCP effect annotations. Extension catalog,
