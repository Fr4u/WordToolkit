...
- `source.native_action_contract_sha256`: canonical native 121-action subset, core
...
This keeps discovery bounded instead of paying for all 121 schemas.
...
All 121 operations have input schemas and MCP effect annotations. Extension catalog,
observability and OOXML-encryption/numbering inspection, semantic query,
typed heading-outline inspection, semantic HTML/SVG rendering, semantic-style
