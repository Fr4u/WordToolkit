...
- `source.native_action_contract_sha256`: canonical native 89-action subset, core
...
This keeps discovery bounded instead of paying for all 89 schemas.
...
All 89 operations have input schemas and MCP effect annotations. Semantic query,
