...
- `source.native_action_contract_sha256`: canonical native 99-action subset, core
...
This keeps discovery bounded instead of paying for all 99 schemas.
...
All 99 operations have input schemas and MCP effect annotations. Semantic query,
