...
- `source.native_action_contract_sha256`: canonical native 117-action subset, core
...
This keeps discovery bounded instead of paying for all 117 schemas.
...
All 117 operations have input schemas and MCP effect annotations. Extension catalog,
...
patch rollback plan/apply pair, numbering-repair plan/apply pair and Flat OPC conversion have explicit
