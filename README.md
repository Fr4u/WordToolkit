...
not flatten the 130-action schema set into model context. The normative shape is
...
The development manifest/runtime is 0.43.0. The latest immutable public release remains
