...
not flatten the 136-action schema set into model context. The normative shape is
...
The development manifest/runtime is 0.45.0. The latest immutable public release remains
