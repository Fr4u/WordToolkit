...
not flatten the 139-action schema set into model context. The normative shape is
...
The development manifest/runtime is 0.46.0. The latest immutable public release remains
