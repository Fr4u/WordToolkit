...
not flatten the 133-action schema set into model context. The normative shape is
...
The development manifest/runtime is 0.44.0. The latest immutable public release remains
