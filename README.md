...
not flatten the 143-action schema set into model context. The normative shape is
...
The development manifest/runtime is 0.48.0. The latest immutable public release remains
