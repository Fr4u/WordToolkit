...
class BookmarksMixin:
    ...
    def add_bookmark(self, para_id: str, name: str) -> dict:
        ...
        Places bookmarkStart after pPr and before content, and bookmarkEnd last.
        ...
        # pPr, when present, is required to be the first paragraph child.
        para.insert(1 if para.find(f"{W}pPr") is not None else 0, bm_start)
        para.append(bm_end)
