    ...
    def add_list(
        ...
        *,
        ...
        Args:
            ...
            start: First displayed number for numbered lists.
        """
        ...
        first_num = num_tree.find(f"{W}num")
        if first_num is None:
            num_tree.append(abstract)
        else:
        ...
        return {"list_id": num_id, "paragraphs_updated": count, "start": start}
