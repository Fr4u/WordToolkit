...
{
    private static Task<object> InspectPackageSemanticRolesAsync(
        JsonElement arguments,
        CancellationToken cancellationToken
    ) => ExecuteSemanticRoleAction(() =>
    {
        var started = Stopwatch.GetTimestamp();
        var request = SemanticRoleOperationJson.ParseInspectRequest(arguments.GetRawText());
    ...
    private static Task<object> ExecuteSemanticRoleAction(Func<object> action)
    {
        try
        {
