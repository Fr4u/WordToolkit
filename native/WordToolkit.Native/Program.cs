...
internal static class Program
{
    ...
    public static async Task<int> Main(string[] args)
    {
        ...
        if (args.Length >= 1 && args[0] == "libreoffice-render-package")
        {
            return await LibreOfficeRenderPackageCli.RunAsync(
                args[1..],
                Console.In,
                Console.Out,
                Console.Error
        ...
        if (args.Length >= 1 && args[0] == "inspect-signatures")
        {
            return InspectSignaturesCli.Run(args[1..], Console.Out, Console.Error);
        }

        if (args.Length >= 1 && args[0] == "analyze-package")
        {
            return DocumentAnalysisPackageCli.Run(
                args[1..],
                Console.In,
                Console.Out,
                Console.Error
        ...
        if (args.Length >= 1 && args[0] == "mail-merge-schema-package")
        {
            return MailMergeSchemaPlanPackageCli.Run(
                args[1..],
                Console.In,
                Console.Out,
                Console.Error
        ...
        if (args.Length >= 1 && args[0] == "ocr-provider-trust")
        {
            return OcrProviderTrustCli.Run(
                args[1..],
                Console.In,
                Console.Out,
                Console.Error
