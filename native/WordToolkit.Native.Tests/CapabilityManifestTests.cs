...
public sealed class CapabilityManifestTests
{
    ...
    public void ManifestIsPagedTokenLeanHonestAndOperationSpecific()
    {
        ...
        Assert.Equal(125, manifest["operation_count"]!.GetValue<int>());
        ...
        Assert.Equal(125, manifest["metadata_coverage"]!["input_schema"]!.GetValue<int>());
        Assert.Equal(125, manifest["metadata_coverage"]!["mcp_effect_annotations"]!.GetValue<int>());
