...
public sealed class CapabilityManifestTests
{
    ...
    public void ManifestIsPagedTokenLeanHonestAndOperationSpecific()
    {
        ...
        Assert.Equal(148, manifest["operation_count"]!.GetValue<int>());
        ...
        Assert.Equal(148, manifest["metadata_coverage"]!["input_schema"]!.GetValue<int>());
        Assert.Equal(148, manifest["metadata_coverage"]!["mcp_effect_annotations"]!.GetValue<int>());
        Assert.Equal(59, manifest["metadata_coverage"]!["explicit_output_schema"]!.GetValue<int>());
        Assert.Equal(59, manifest["metadata_coverage"]!["explicit_permissions"]!.GetValue<int>());
        Assert.Equal(59, manifest["metadata_coverage"]!["explicit_reversibility"]!.GetValue<int>());
        Assert.Equal(59, manifest["metadata_coverage"]!["explicit_operation_version"]!.GetValue<int>());
        Assert.Equal(
            "operation-specific",
