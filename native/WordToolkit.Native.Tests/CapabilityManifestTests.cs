...
public sealed class CapabilityManifestTests
{
    ...
    public void ManifestIsPagedTokenLeanHonestAndOperationSpecific()
    {
        ...
        Assert.Equal(84, manifest["operation_count"]!.GetValue<int>());
        ...
        Assert.Equal(84, manifest["metadata_coverage"]!["input_schema"]!.GetValue<int>());
        Assert.Equal(84, manifest["metadata_coverage"]!["mcp_effect_annotations"]!.GetValue<int>());
